...
export const PROJECTS_CONTENT = [
  {
    ...
    focusAreas: ["Personalization", "Clean design", "Meaningful insights"]
  },
  {
    id: "02",
    ...
    note: "This product is being developed carefully with a long-term vision."
  }
];
...
export const LEADERSHIP_CONTENT = [
  {
    ...
    skills: [
      "Technical Research & Academic Writing",
      "WordPress, PHP, HTML, & CSS",
      "Figma & Canva UI/UX",
      "Git, GitHub & Vercel",
      "MySQL (XAMPP)",
      "Strategic Project Management",
      "Video Creation & Social Growth",
      "Kali Linux & Security Documentation"
    ]
  },
  {
...
export const TEAM_MEMBERS = [
  ...
  { 
    name: "Haseeb Ahmad", 
    role: "Node.js & NextJS Developer", 
    bio: "Expertise in PostgreSQL, REST APIs, and JWT Authentication.",
  ...
  { 
    ...
    bio: "Focus on UI Styling, Responsive Design (HTML5/CSS3), and Team Collaboration.",
    whatsapp: "https://wa.me/+923127641850",
    linkedin: "https://www.linkedin.com/in/m-shehram-6a706639b/",
    email: "mailto:Vyora.ai001@gmail.com"
  },
